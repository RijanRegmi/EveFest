          ...
          <div className="tickets-grid">
            {bookings.length === 0 ? (
              ...
              bookings.map((booking) => {
                const bookingEvent = typeof booking.event === "object" ? booking.event : null;
                const bookingEventTitle = bookingEvent ? bookingEvent.title : "Event Details";
                const bookingEventDate = bookingEvent ? bookingEvent.date : "";
                const bookingEventTime = bookingEvent ? bookingEvent.time : "";
                const bookingEventLocation = bookingEvent ? bookingEvent.location : "";
                const bookingEventId = bookingEvent ? bookingEvent._id : (typeof booking.event === "string" ? booking.event : "");
                  ...
                  <div key={booking._id} className="ticket-pass glass-panel animate-slide-up">
                    ...
                    <div className="ticket-details-side">
                      ...
                      <h3 
                        ...
                        onClick={() => {
                          if (bookingEventId) {
                            window.location.href = `/event/${bookingEventId}?view=dashboard`;
                          }
                        }}
                      ...
                      <div className="ticket-meta-info">
                        <div className="ticket-meta-item">
                          <Calendar size={14} />
                          <span>{bookingEventDate} | {bookingEventTime}</span>
                        </div>
                        <div className="ticket-meta-item">
                          <MapPin size={14} />
                          <span>{bookingEventLocation}</span>
                        </div>
                      </div>
