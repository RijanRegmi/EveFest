          ...
          <section className="guide-faq-section container">
            <div className="guide-card glass-panel">
              ...
              <p className="guide-desc">
                Welcome to the official Event Hub! A trusted university space to connect with student societies, explore workshops, register for coding hackathons, or coordinate your own group events.
              </p>
