...
export default function EditEventPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      fd.append("isOnline", String(formData.isOnline));
      ...
      fd.append("price", String(formData.isPaid ? Number(formData.price) : 0));
      fd.append("limit", formData.limit === "unlimited" ? "unlimited" : String(Number(formData.limitCount)));
      fd.append("rules", formData.rules);
      fd.append("maxSeatsPerUser", String(Number(formData.maxSeatsPerUser || 5)));
  ...
  if (user && event && user._id !== event.hostId) {
    return (
      <>
        <Navbar />
        ...
        <div className="hosting-grid">
          <div className="form-card-wrapper glass-panel">
            ...
            <form onSubmit={handleSubmit} className="event-creation-form">
              ...
              {/* Section 2: Banner */}
              <div className="form-section">
                <h3 className="section-title"><ImageIcon size={16} />2. Event Banner Image</h3>
                <div>
                  <div
              ...
              {/* Section 3: Logo */}
              <div className="form-section">
                <h3 className="section-title"><ImageIcon size={16} />3. Organizer / Event Logo <span className="optional-tag">Optional</span></h3>
